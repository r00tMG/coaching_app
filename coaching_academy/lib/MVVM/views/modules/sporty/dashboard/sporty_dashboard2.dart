...
import 'package:coaching_academy/MVVM/views/modules/sporty/home/sporty_services.dart';
...
class SportyDashboard2 extends StatefulWidget {
  final int indexx;
  final String? location;
  const SportyDashboard2({
    super.key,
    this.location,
  ...
  @override
  State<SportyDashboard2> createState() => _SportyDashboard2State();
}

class _SportyDashboard2State extends State<SportyDashboard2> {
  bool isLocationEmpty = false;

  int pageIndex = 0;
  final pages = [
    const SportyServices(),
    const MessagesHome(),
  ...
  void initState() {
    super.initState();
    pageIndex = widget.indexx; // Use the value from the widget
  }
